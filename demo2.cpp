...
void render()
{
    ...
    // glUniform3f(glGetUniformLocation(shader, "color"), 1, 0.4, 1);
    glUniform3f(glGetUniformLocation(shader, "color"), x, y, z);
    glUniform1f(glGetUniformLocation(shader, "theta"), theta);
    // glUniform1f(glGetUniformLocation(shader, "rgb"), t);
